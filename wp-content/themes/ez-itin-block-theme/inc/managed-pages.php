...
const EZ_ITIN_MANAGED_PAGES_VERSION = '1.0.0';
...
<div class="ez-managed-page ez-service-page">
  ...
  <section id="start" class="ez-mp-cta"><div class="ez-shell"><div><p class="ez-mp-kicker">Start with the tax purpose</p><h2>Prepare your ITIN application with a CAA review</h2><p>Bring the U.S. tax notice, K-1, withholding statement, property record, return, or other document that explains why the taxpayer number is needed.</p></div><a class="ez-mp-button ez-mp-button--primary" href="mailto:help@ez-itin.com?subject=ITIN%20application%20review">Request an application review</a></div></section>
</div>
HTML;
...
<div class="ez-managed-page ez-resources-page">
  ...
  <section id="guides" class="ez-mp-section"><div class="ez-shell"><div class="ez-mp-heading"><div><p class="ez-mp-kicker ez-mp-kicker--blue">ITIN knowledge base</p><h2>Choose the guide that matches your next decision</h2></div><p>These guides explain the workflow in plain language and link to primary IRS sources. They do not replace the current instructions or case-specific tax advice.</p></div><div class="ez-mp-resource-grid"><a href="#what-is-an-itin"><span>01</span><h3>What is an ITIN?</h3><p>Purpose, limits, SSN eligibility, and common reasons a foreign person may need one.</p></a><a href="#form-w7"><span>02</span><h3>Form W-7 guide</h3><p>Application reasons, return attachments, exception evidence, and signature controls.</p></a><a href="#supporting-documents"><span>03</span><h3>Supporting documents</h3><p>Passport rules, acceptable alternatives, certified copies, and CAA examination.</p></a><a href="#nonresident-filing"><span>04</span><h3>Nonresident tax return</h3><p>How Form 1040-NR and U.S. income documents connect to a first ITIN filing.</p></a><a href="#renewals"><span>05</span><h3>ITIN renewal</h3><p>Three-year nonuse expiration, when renewal is necessary, and what not to send.</p></a><a href="#international-guides"><span>06</span><h3>Country guides</h3><p>Local naming, address, foreign tax-number, treaty, and document considerations.</p></a></div></div></section>
  ...
  <section class="ez-mp-cta"><div class="ez-shell"><div><p class="ez-mp-kicker">Need case-specific help?</p><h2>Move from ITIN research to a reviewed application</h2><p>Our Certifying Acceptance Agent service connects the tax reason, Form W-7, identity evidence, and submission package.</p></div><a class="ez-mp-button ez-mp-button--primary" href="/itin-application-service/#start">Explore ITIN application assistance</a></div></section>
</div>
HTML;
    return ez_itin_html_block(str_replace('{{FAQS}}', ez_itin_render_faqs($faqs), $html));
}
...
<div class="ez-managed-page ez-country-hub">
  ...
  <section class="ez-mp-cta"><div class="ez-shell"><div><p class="ez-mp-kicker">Prepare from anywhere</p><h2>Start with your country and U.S. tax reason</h2><p>Use the country guide, then move into a coordinated Form W-7 and document review.</p></div><a class="ez-mp-button ez-mp-button--primary" href="/itin-application-service/#start">Request ITIN application assistance</a></div></section>
</div>
HTML;
...
<div class="ez-managed-page ez-country-page">
  ...
  <section id="country-overview" class="ez-mp-section"><div class="ez-shell ez-mp-article"><div><p class="ez-mp-kicker ez-mp-kicker--blue">' . esc_html($data['focus']) . '</p><h2>' . esc_html($data['intro_title']) . '</h2></div><div>' . $intro . '<p>Our CAA review does not promise approval. It is designed to make the tax purpose, Form W-7 category, identity records, and supporting filing tell the same story before the IRS receives the package.</p></div></div></section>
  <section id="country-scenarios" class="ez-mp-section ez-mp-section--paper"><div class="ez-shell"><div class="ez-mp-heading"><div><p class="ez-mp-kicker ez-mp-kicker--blue">Common ' . esc_html($data['demonym']) . ' filing situations</p><h2>When a U.S. tax event can create an ITIN need</h2></div><p>These scenarios can support a review, but no investment, company, property, payment, or family relationship guarantees eligibility on its own.</p></div><div class="ez-mp-scenario-grid">' . $scenario_html . '</div></div></section>
  <section class="ez-mp-section ez-mp-section--dark"><div class="ez-shell ez-mp-article"><div><p class="ez-mp-kicker">Country-specific tax context</p><h2>' . esc_html($data['country_note_title']) . '</h2></div><div><p>' . esc_html($data['country_note']) . '</p><p>Any treaty or domestic-law position must remain consistent across the payer documentation, federal return, exception evidence, and Form W-7 reason. The ITIN itself does not grant a tax benefit.</p><a class="ez-mp-link ez-mp-link--light" href="https://www.irs.gov/businesses/international-businesses/united-states-income-tax-treaties-a-to-z" rel="noopener noreferrer">Review official IRS treaty resources →</a></div></div></section>
  <section id="country-process" class="ez-mp-section"><div class="ez-shell ez-mp-split"><div class="ez-mp-sticky"><p class="ez-mp-kicker ez-mp-kicker--blue">' . esc_html($data['country']) . ' ITIN application process</p><h2>From cross-border tax event to a complete Form W-7 package</h2><p>Preparation begins with records, not original-document shipping. We first establish whether the applicant has a valid tax reason and which filing route fits.</p></div><ol class="ez-mp-steps"><li><span>01</span><div><h3>Review the U.S. tax purpose</h3><p>We examine the income statement, K-1, property record, federal filing, treaty document, family return, or other evidence that explains the ITIN need.</p></div></li><li><span>02</span><div><h3>Map local identity to U.S. records</h3><p>The passport name, foreign address, local tax number when applicable, birth details, and existing U.S. forms are reconciled.</p></div></li><li><span>03</span><div><h3>Prepare Form W-7 and supporting filing</h3><p>The W-7 reason is matched to the federal return or exact exception documentation, with the correct tax year and signatures.</p></div></li><li><span>04</span><div><h3>Complete document examination and submission</h3><p>Eligible original documents are handled through the selected IRS or CAA route, and the completed package is assembled for filing.</p></div></li></ol></div></section>
  <section id="country-documents" class="ez-mp-section ez-mp-section--blue"><div class="ez-shell ez-mp-split ez-mp-split--reverse"><div><p class="ez-mp-kicker ez-mp-kicker--blue">Documents for an ITIN from ' . esc_html($data['country']) . '</p><h2>Prepare identity evidence that remains consistent across borders</h2><p>The document choice must satisfy the current Form W-7 instructions. A scan begins our quality review; it is not automatically acceptable as the final evidence sent to the IRS.</p><p>When a CAA is permitted to certify the document, the agent examines the original and follows the Certificate of Accuracy procedure. Some dependent applications and document types have additional restrictions.</p></div><div class="ez-mp-checks">' . $document_html . '</div></div></section>
  <section id="country-faq" class="ez-mp-section ez-mp-section--paper"><div class="ez-shell ez-mp-faq-layout"><div><p class="ez-mp-kicker ez-mp-kicker--blue">' . esc_html($data['country']) . ' ITIN FAQ</p><h2>Country-specific answers before filing</h2><p>The IRS decides eligibility. These answers help identify the records that should be reviewed before submission.</p></div><div class="ez-mp-faqs">' . ez_itin_render_faqs($data['faqs']) . '</div></div></section>
  ...
  <section id="country-start" class="ez-mp-cta"><div class="ez-shell"><div><p class="ez-mp-kicker">Start your ' . esc_html($data['country']) . ' application review</p><h2>Connect Form W-7 to the U.S. tax reason</h2><p>Share the record that explains the federal filing need before sending original identity documents.</p></div><a class="ez-mp-button ez-mp-button--primary" href="mailto:help@ez-itin.com?subject=' . rawurlencode($data['country'] . ' ITIN application review') . '">Request a CAA review</a></div></section>
</div>';
    return ez_itin_html_block($html);
}
...
function ez_itin_managed_pages(): array
{
    ...
    $pages = [
        'itin-application-service' => [
            'title' => 'ITIN Application Service | Certifying Acceptance Agent',
            'description' => 'Get ITIN application service from an IRS Certifying Acceptance Agent. Form W-7 preparation, passport verification, and worldwide filing support.',
            'focus' => 'ITIN application service',
            'schema' => 'Service',
            'faqs' => ez_itin_service_faqs(),
...
function ez_itin_provision_managed_pages(): void
{
    ...
    $primary_id = ez_itin_upsert_page('itin-application-service', 'ITIN Application Service', $definitions['itin-application-service']['content']);
...
add_action('template_redirect', static function (): void {
    ...
    $redirects = [
        ...
        'start-application' => '/itin-application-service/#start',
        ...
        'faq' => '/itin-application-service/#faq',
    ];
