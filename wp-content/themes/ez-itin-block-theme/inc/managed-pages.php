...
const EZ_ITIN_MANAGED_PAGES_VERSION = '1.2.0';
...
function ez_itin_country_page_html(string $slug, array $data): string
{
    ...
    $html = '
<div class="ez-managed-page ez-country-page alignfull">
  <section class="ez-mp-hero ez-mp-hero--country" aria-labelledby="country-title"><div class="ez-shell ez-mp-hero__grid"><div><p class="ez-mp-kicker">' . esc_html($data['country']) . ' • IRS Certifying Acceptance Agent</p><h1 id="country-title">ITIN Application from ' . esc_html($phrase_country) . ': CAA Assistance</h1><p class="ez-mp-lede">' . esc_html($data['hero']) . '</p><div class="ez-mp-actions"><a class="ez-mp-button ez-mp-button--primary" href="#country-start">Start a ' . esc_html($data['country']) . ' ITIN review</a><a class="ez-mp-button ez-mp-button--ghost" href="#country-eligibility">Check common situations</a></div><ul class="ez-mp-proof"><li>Form W-7 preparation</li><li>CAA passport review</li><li>U.S. tax coordination</li></ul></div><aside class="ez-mp-status ez-mp-status--service" aria-label="CAA assistance for applicants in ' . esc_attr($data['country']) . '"><p>Country-focused CAA service</p><strong>Streamlined ITIN Application from ' . esc_html($phrase_country) . ' with CAA Assistance</strong><small>Country-aware preparation that connects Form W-7, eligible identity evidence, and the supporting U.S. federal tax reason.</small><hr><ol><li><span>01</span>Apply from ' . esc_html($data['country']) . ' <b>Remotely</b></li><li><span>02</span>Eligible passport <b>CAA reviewed</b></li><li><span>03</span>Form W-7 package <b>Coordinated</b></li></ol><small>The IRS makes every eligibility, processing-time, and issuance decision.</small></aside></div></section>
  <nav class="ez-mp-jump" aria-label="Country guide topics"><div class="ez-shell"><span>' . esc_html($data['country']) . ' ITIN service</span><a href="#country-service">Services</a><a href="#country-eligibility">Eligibility</a><a href="#country-process">Process</a><a href="#country-documents">Documents</a><a href="#country-faq">FAQ</a></div></nav>
  <section class="ez-mp-band" aria-label="ITIN services for ' . esc_attr($data['country']) . ' residents"><div class="ez-shell ez-mp-metrics"><div><strong>Form W-7</strong><span>Prepared for the correct federal reason</span></div><div><strong>CAA assistance</strong><span>Eligible original documents examined</span></div><div><strong>From ' . esc_html($data['country']) . '</strong><span>International application coordination</span></div><div><strong>U.S. tax filing</strong><span>Return or exception evidence matched</span></div></div></section>
  ...
  <section id="country-service" class="ez-mp-section ez-mp-section--paper"><div class="ez-shell"><div class="ez-mp-heading"><div><p class="ez-mp-kicker ez-mp-kicker--blue">International ITIN application service</p><h2>ITIN services for ' . esc_html($data['country']) . ' residents</h2></div><p>Our country-focused service combines the commercial goal with the federal filing requirement, so the application is not treated as an isolated form or passport-copy task.</p></div><div class="ez-mp-card-grid ez-mp-card-grid--4"><article><span class="ez-mp-icon">W7</span><h3>Form W-7 preparation from ' . esc_html($data['country']) . '</h3><p>Application reason, legal identity, foreign address, tax year, and supporting filing are prepared as one consistent record.</p></article><article><span class="ez-mp-icon">CAA</span><h3>CAA assistance for ' . esc_html($data['demonym']) . ' applicants</h3><p>An IRS Certifying Acceptance Agent reviews the filing route and examines eligible original identity documents under applicable procedures.</p></article><article><span class="ez-mp-icon">ID</span><h3>Passport verification for an ITIN</h3><p>Many eligible applicants can retain control of an original passport instead of mailing it to the IRS, subject to CAA and dependent rules.</p></article><article><span class="ez-mp-icon">US</span><h3>U.S. tax filing coordination</h3><p>Form 1040-NR, withholding records, Schedule K-1, property documents, or exception evidence are matched to the W-7 reason.</p></article></div></div></section>
  <section id="country-eligibility" class="ez-mp-section"><div class="ez-shell"><div class="ez-mp-heading"><div><p class="ez-mp-kicker ez-mp-kicker--blue">Common ' . esc_html($data['demonym']) . ' filing situations</p><h2>Who may need an ITIN while living in ' . esc_html($data['country']) . '</h2></div><p>The four ' . esc_html($data['demonym']) . ' patterns below are useful starting points, not automatic qualifications. A documented U.S. reporting event must connect the person, tax year, and requested number.</p></div><div class="ez-mp-scenario-grid">' . $scenario_html . '</div><div class="ez-mp-inline-cta"><div><strong>Unsure whether your U.S. activity supports Form W-7?</strong><span>Start with the tax document or transaction that created the need—not the passport.</span></div><a class="ez-mp-button ez-mp-button--primary" href="#country-start">Check your filing route</a></div></div></section>
  ...
  <section class="ez-mp-section ez-mp-section--dark"><div class="ez-shell ez-mp-split"><div><p class="ez-mp-kicker">Certifying Acceptance Agent for ' . esc_html($data['country']) . ' applicants</p><h2>A controlled route for Form W-7 and eligible passport evidence</h2><p>CAA assistance is most useful when the applicant wants one review connecting identity, the U.S. tax purpose, and the final submission order. It is not an approval shortcut and does not change IRS processing time.</p><a class="ez-mp-link ez-mp-link--light" href="/itin-application-service/">Compare complete CAA Services →</a></div><div class="ez-mp-compare"><div><span>Application element</span><strong>Country-focused review</strong></div><div><span>' . esc_html($data['country']) . ' identity records</span><b>Matched</b></div><div><span>Form W-7 and tax purpose</span><b>Coordinated</b></div><div><span>Eligible original passport</span><b>CAA procedure</b></div><div><span>ITIN decision</span><b>IRS only</b></div></div></div></section>
  <section id="country-faq" class="ez-mp-section ez-mp-section--paper"><div class="ez-shell ez-mp-faq-layout"><div><p class="ez-mp-kicker ez-mp-kicker--blue">' . esc_html($data['country']) . ' ITIN FAQ</p><h2>Questions about applying for an ITIN from ' . esc_html($phrase_country) . '</h2><p>These ' . esc_html($data['country']) . ' answers identify the records and cross-border details worth resolving first. They do not replace the IRS eligibility decision.</p></div><div class="ez-mp-faqs">' . ez_itin_render_faqs($data['faqs']) . '</div></div></section>
  ...
  <section id="country-start" class="ez-mp-cta"><div class="ez-shell"><div><p class="ez-mp-kicker">Start your ' . esc_html($data['focus']) . ' review</p><h2>Request CAA assistance from ' . esc_html($phrase_country) . '</h2><p>Begin with the U.S. tax notice, K-1, withholding statement, property record, return, or transaction that explains why the ITIN is needed. We review the filing route before requesting eligible original evidence.</p></div><div class="ez-mp-cta__actions"><a class="ez-mp-button ez-mp-button--primary" href="/itin-application-service/#caa-start">Start the ITIN review</a><a class="ez-mp-link" href="mailto:help@ez-itin.com?subject=' . rawurlencode($data['country'] . ' ITIN application review') . '">Email a case question</a></div></div></section>
</div>';
    return ez_itin_html_block($html);
}
...
function ez_itin_store_page_seo(int $post_id, array $definition): void
{
    ...
    $rank_math_keywords = [$definition['focus']];
    if (!empty($definition['country'])) {
        $country = (string) $definition['country'];
        $rank_math_keywords[] = 'ITIN services for ' . $country . ' residents';
        $rank_math_keywords[] = 'CAA assistance for ' . $country . ' applicants';
        $rank_math_keywords[] = 'Form W-7 preparation from ' . $country;
        $rank_math_keywords[] = 'Certifying Acceptance Agent for ' . $country;
    }
    update_post_meta($post_id, 'rank_math_focus_keyword', implode(', ', $rank_math_keywords));
...
add_action('wp_head', static function (): void {
    ...
    if ($page['schema'] === 'Service') {
        ...
        $primary['audience'] = [
            '@type' => 'Audience',
            'audienceType' => isset($page['country'])
                ? 'ITIN applicants living in ' . $page['country']
                : 'International ITIN applicants',
        ];
        $primary['availableChannel'] = [
            '@type' => 'ServiceChannel',
            'serviceUrl' => home_url('/itin-application-service/#caa-start'),
